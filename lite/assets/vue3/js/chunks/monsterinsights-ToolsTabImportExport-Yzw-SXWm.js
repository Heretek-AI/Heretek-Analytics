...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const text_import_description = __("Import settings from another Heretek Analytics website.", "google-analytics-for-wordpress");
    const text_export = __("Export", "google-analytics-for-wordpress");
    const text_export_description = __("Export settings to import into another Heretek Analytics install.", "google-analytics-for-wordpress");
    ...
    const text_import_tooltip = sprintf(__("Select %1$sChoose file%2$s to upload a settings export file from another Heretek Analytics website.", "google-analytics-for-wordpress"), "<strong>", "</strong>");
    const text_export_tooltip = sprintf(__("Click %1$sExport Settings%2$s to export a file with your Heretek Analytics settings.", "google-analytics-for-wordpress"), "<strong>", "</strong>");
    ...
    function showImportError() {
      {
        dialog.alert({
          ...
          message: __("Please choose a .json file generated by a Heretek Analytics settings export.", "google-analytics-for-wordpress"),
          confirmText: __("Ok", "google-analytics-for-wordpress")
        });
      }
    }
