...
function monsterinsights_get_url($medium = '', $campaign = '', $url = '', $escape = true)
{
	...
	$url         = !empty($url) ? $url : 'https://github.com/Heretek-AI/Heretek-Analytics';

	if ( strpos( $url, 'monsterinsights.com' ) !== false ) {
	...
	$url = add_query_arg(
		array(
			...
			'utm_medium'   => sanitize_key($medium),   // Area of Heretek Analytics
			'utm_campaign' => sanitize_key($campaign), // Which link
			'utm_content'  => $content,  // Version number
		),
		$url
	);
...
function monsterinsights_get_inline_menu_icon() {
	return 'data:image/png;base64,';
}
...
function monsterinsights_get_shareasale_url( $shareasale_id, $shareasale_redirect ) {
	...
	$shareasale_url      = "https://github.com/Heretek-AI/Heretek-Analytics";
...
function monsterinsights_detect_tracking_code_error( $body ) {
	...
	if ( $total_count > $limit ) {
		...
		$message           = esc_html__( '%1$sWe have detected multiple tracking codes%2$s! You should remove duplicate or conflicting tracking scripts. For guidance please %3$sread this documentation%4$s.', 'google-analytics-for-wordpress' );
		$url               = 'https://github.com/Heretek-AI/Heretek-Analytics#readme';
